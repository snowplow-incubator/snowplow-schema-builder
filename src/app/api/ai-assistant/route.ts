...
function createPrompt(useCaseDescription: string, reports: string[]) {
  return `Please suggest a tracking design addressing the following use case: ${useCaseDescription}
Your tracking design should consist of a set of events and reusable entities.
...
I am interested in using the dimensions to create the following reports:
- ${reports.join("\n- ")}

The answer should consist of two JSON lists - one for events and one for entities. Each list should contain objects with "name", "description" and "properties" fields. The properties should be a list of objects with "name", "description" and "type" fields.`
}
